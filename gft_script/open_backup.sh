...
#--tab -e "bash -c 'printf \"\033]0;TEST2\007\"; ./sql_ft2;bash'" \
#--tab -e "bash -c 'printf \"\033]0;TEST3\007\"; ./run_ft2;bash'" \
#--tab -e "bash -c 'printf \"\033]0;TEST4\007\"; ./run_ft3;bash'" \
gnome-terminal --window -e "bash -c 'printf \"\033]0;BACKUP1\007\"; ./recv_b;bash'" \
--tab -e "bash -c 'printf \"\033]0;BACKUP2\007\"; ./recv_sql;bash'" \
